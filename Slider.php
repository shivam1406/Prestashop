...
include_once(_PS_MODULE_DIR_.'Slider/HomeSlide.php');
...
class Slider extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->getTranslator()->trans('Slider', array(), 'Modules.Imageslider.Admin');
    ...
    protected function installSamples()
    {
        ...
        for ($i = 1; $i <= 3; ++$i) {
            ...
            foreach ($languages as $language) {
                ...
                $slide->url[$language['id_lang']] = 'http://www.google.com/'
    ...
    public function getSlides($active = null)
    {
        ...
        foreach ($slides as &$slide) {
            $slide['image_url'] = $this->context->link->getMediaLink(_MODULE_DIR_.'Slider/images/'.$slide['image']);
